...
```{r monitoramento_mes-transparencia, fig.height=7, fig.width=12, echo=FALSE}
monitoramento_mes(indice, idx = "Transparência")
```

```{r monitoramento_mes-completude, fig.height=7, fig.width=12, echo=FALSE}
monitoramento_mes(indice, idx = "Completude")
```

```{r monitoramento_mes-facilidade, fig.height=7, fig.width=12, echo=FALSE}
...
```{r formato-de-acesso, fig.height=8}
indice %>%
  transmute(
    orgao,
    data,
