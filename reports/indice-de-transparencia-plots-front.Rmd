...
# 
# set.seed(1014)
# options(digits = 2, scipen = 999, OutDec = ",", hrbrthemes.loadfonts = TRUE)
```
...
```{r dados-mp}
mps = orgaos %>% filter(str_detect(aid, "^mp"))
  #filter(entity %in% c("Ministério", "M"), type %in% c("Estadual", "E"))
